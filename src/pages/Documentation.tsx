    ...
    return (
        <GlassLayout>
            <div className="flex h-screen pt-20 overflow-hidden relative">
                ...
                {/* Sidebar */}
                <aside className="w-72 border-r border-white/10 bg-black/20 backdrop-blur-md flex flex-col">
                    <div className="p-6">
                        <button
                        ...
                        <nav className="space-y-6 overflow-y-auto pr-2 custom-scrollbar max-h-[calc(100vh-250px)]">
                                ...
                                <div className="prose prose-invert prose-lg max-w-none">
                                    <div className="whitespace-pre-wrap text-gray-300">
                                        {selectedContent.content.split('\n').map((line, i) => {
                                            ...
                                            if (line.startsWith('```')) return null; // Handle code blocks separately if doing full markdown parsing, but for now simple rendering
